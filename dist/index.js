...
const DVD_1 = require("./models/subclasses/DVD");
const Livro_1 = require("./models/subclasses/Livro");
//import { biblioteca } from './bd/bd';
const dvd1 = new DVD_1.DVD(1212, 'a', 5, 'b', 'c');
const livro1 = new Livro_1.Livro(1212, 'a', 5, 4, 'c');
